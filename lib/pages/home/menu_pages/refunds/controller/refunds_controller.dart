...
// //--------------customers api methods--------------
  ...
  Future getMyRefunds() async {
    try {
      getRefundsFlag = true;
      await sslProblem();
      var res = await dio.get(EndPoints.getRefunds);
      List<Refund> tmp = [];
      for (var i in res.data["data"]) {
        Refund c = Refund.fromJson(i);
        tmp.add(c);
      }
      refunds = tmp;
      refundsToShow = tmp;
