...
import 'package:safqa/admin/pages/addresses/tabs/cities/create_city.dart';
...
class _CitiesTabState extends State<CitiesTab> {
  ...
  @override
  void initState() {
    _globalDataController.getCities();
    super.initState();
  }
