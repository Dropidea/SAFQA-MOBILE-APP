...
class LanguagesMainPage extends StatefulWidget {
  LanguagesMainPage({super.key});

  @override
  State<LanguagesMainPage> createState() => LanguagesMainPageState();
}

class LanguagesMainPageState extends State<LanguagesMainPage> {
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    whiteText("languages".tr, 17, fontWeight: FontWeight.w600),
                    Opacity(
                      opacity: 0,
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                          child: GetBuilder<LanguageController>(builder: (c) {
                        return c.getLanguagesFlag
                            ? Center(
                                    ...
                                    child: Stack(
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            blackText(
                                                c.Languages[index].name!, 15),
                                            greyText(
                                                c.Languages[index].shortName!,
                                                15),
                                            greyText(
                                                c.Languages[index].slug!, 15),
                                          ],
                                        ),
